...
{
    public class UnsubscribedIndexViewModel
    {
        ...
        private DateTime _dtUnsubscribe;
        [Display(Name = "Дата отписки от группы")]
        [DisplayFormat(ConvertEmptyStringToNull = true, DataFormatString = "{0:dd MMMM yyyy HH:mm}")]
        public DateTime DtUnsubscribe { get { return _dtUnsubscribe.ToLocalTime(); } set { _dtUnsubscribe = value; } }
        [Display(Name = "Можно отправлять сообщения?")]
        public bool? IsChatAllowed { get; internal set; }
    }
}
